...
app_description = "A app to integrate attendance device with hmrs."
...
add_to_apps_screen = [
	{
		...
		"logo": "/assets/attendance_sync/logo.png",
		"title": "Attendance Sync",
		"route": "/app/device-configuration",
...
scheduler_events = {"hourly": ["attendance_sync.utils.get_attendance_from_device"]}
